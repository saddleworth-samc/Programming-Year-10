...
#To add:
#Test mode - randomly picks questions.
...
#MINUS = 5
    print("\n")
elif calculator == ("-") or calculator == ("minus") or calculator == ("Minus") or calculator == ("Subtract") or calculator == ("subtract") or calculator == ("5"):
...
#MULTIPLY = 6
elif calculator == ("*") or calculator == ("Times") or calculator == ("times") or calculator == ("Multiply") or calculator == ("multiply") or calculator == ("6"):
    print("\n")
...
#Powers = 3
elif calculator == ("**") or calculator == ("Power") or calculator == ("powers") or calculator == ("Powers") or calculator == ("power") or calculator == ("3"):
    print("\n")
...
#Square Root = 9
elif calculator == ("Square Root") or calculator == ("square root") or calculator == ("squareroot") or calculator == ("SquareRoot") or calculator == ("9"):
    print("\n")
...
#Percentage = 8
elif calculator == ("Percentage") or calculator == ("percentage") or calculator == ("percent") or calculator == ("Percent") or calculator == ("8"):
    num1 = int(input("Enter the first number: "))
    num2 = int(input("Enter the second number: "))
    percentage = num1 / num2 * 100
    print (num1 / num2 * 100, "%")
#Remainder = 7
elif calculator == ("Remainder") or calculator == ("remainder") or calculator == ("Remainders") or calculator == ("remainders") or calculator == ("leftover") or calculator == ("7"):
    print("\n")
...
#Factors = 4
elif calculator == ("Factors") or calculator == ("factors") or calculator == ("factor") or calculator == ("Factor") or calculator == ("4"):
    print("\n")
    ...
    for i in range(1, numfactor1 + 1):
        if numfactor1 % i == 0:
            print(i)
#Circle (Area) = 11
elif calculator == "Circle" or calculator == "circle" or calculator == ("11"):
    print("\n")
...
#Rectangle (Area) = 12
elif calculator == "Rectangle" or calculator == "rectangle" or calculator == ("12"):
    print("\n")
    ...
    print("The area is: ", str(area))
#Square (Area) = 10
elif calculator == "Square" or calculator == "square" or calculator == ("10"):
    print("\n")
...
elif calculator == ("Pythagoras Theorem") or calculator == ("pythagoras theorem") or calculator == ("Pythagoras theorem") or calculator == ("14"):
    print("\n")
...
#Times Tables = 13
elif calculator == "Times Tables" or calculator == "Time tables" or calculator == "times tables" or calculator == "Time Table" or calculator == "time table" or calculator == "13":
    print("\n")
